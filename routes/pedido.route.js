...
const { postPedido, getPedidos, getPedidosByDni, getPedidosByState, getPedidosByDate, getPedidosByDates, getPedidosById, updatePedidoById, deletePedidoById } = require("../controllers/pedido.controller");
